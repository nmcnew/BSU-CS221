...
public class QuickSort {
	...
	/**
	 * Sort the table using the quicksort algorithm. pre: table contains
	...
	/**
	 * Sort a part of the table using the quicksort algorithm. post: The part of
	 * table from first through last is sorted.
	 * 
	 * @param table
	 *            The array to be sorted
	 * @param first
	 *            The index of the low bound
	 * @param last
	 *            The index of the high bound
	 */
	...
	private static <T extends Comparable<T>> int partition(T[] table,
		...
		do {
			/*
			 * Invariant: All items in table[first . . . up - 1] <= pivot All
			 * items in table[down + 1 . . . last] > pivot
			 */
