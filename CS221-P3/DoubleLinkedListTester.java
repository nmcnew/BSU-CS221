...
public class DoubleLinkedListTester {
	...
	public static void main(String[] args) {
		...
		tester.runTests();
		// tester.runArrayTest();
		// IteratorTester it = new IteratorTester();
		// it.runTests();
	}
	...
	private IndexedListADT<Integer> newIndexedListRemoveFirstEmpty() {
		IndexedListADT<Integer> someList = newIndexedListAddOne();
		((IndexedListADT<Integer>) someList).removeFirst();
		return someList;
	}

	private IndexedListADT<Integer> newIndexedListRemoveLastEmpty() {
		IndexedListADT<Integer> someList = newIndexedListAddOne();
		((IndexedListADT<Integer>) someList).removeLast();
		return someList;
	}
	...
	private UnorderedListADT<Integer> newIteratorRemoveEmpty() {
		// TODO: enable only one of the two following
		// lines or add a new implementation to test
		DoubleLinkedList<Integer> someList = (DoubleLinkedList<Integer>) newListAddToFrontOne();
		Iterator<Integer> it = someList.listIterator();
		it.next();
		it.remove();
		return someList;
	}
	...
	@SuppressWarnings("unchecked")
	private UnorderedListADT<Integer> newIteratorRemovePreviousEmpty() {
		// TODO: enable only one of the two following
		// lines or add a new implementation to test
		DoubleLinkedList<Integer> someList = (DoubleLinkedList<Integer>) newListAddToFrontOne();
		ListIterator<Integer> it = someList.listIterator();
		it.previous();
		it.remove();
		return someList;
	}
	...
	private void runTests() {
		...
		printTest("testIteratorConstructorOnNewList", testIteratorConstructorOnNewList());
		printTest("testIteratorHasNextOnNewList", testIteratorHasNextOnNewList());
		printTest("testIteratorNextOnNewList", testIteratorNextOnNewList());
		printTest("testIteratorAddOnNewList", testIteratorAddOnNewList());
		printTest("testIteratorHasPreviousOnNewList", testIteratorHasPreviousOnNewList());
		printTest("testIteratorNextIndextOnNewList", testIteratorNextIndexOnNewList());
		printTest("testIteratorPreviousOnNewList", testIteratorPreviousOnNewList());
		printTest("testIteratorPreviousIndexOnNewList", testIteratorPreviousIndexOnNewList());
		printTest("testIteratorRemoveOnNewList", testIteratorRemoveOnNewList());
		printTest("testIteratorSetOnNewList", testIteratorSetOnNewList());
		// TESTS ON AN EMPTY IndexedListADT THAT HAD REMOVE(integer) CALLED
		...
		// TESTS ON A LIST WITH ONE VALUE, AFTER Remove(1st element) TODO
		// TESTS ON A LIST WITH ONE VALUE, AFTER Remove(2nd element) TODO
		...
		// TESTS ON A TWO-ELEMENT LIST THAT HAD REMOVE(C) CALLED
		...
		printTest("testIndexOfOnRemoveIndexedListTwoInvalid", testIndexOfOnRemoveIndexedListTwoInvalid());
		...
		// TESTS ON A TWO-ELEMENT LIST THAT HAD REMOVE(B) CALLED TODO
		// TESTS ON A TWO-ELEMENT LIST THAT HAD REMOVE(A) CALLED TODO
		// TESTS ON A TWO-ELEMENT LIST THAT HAD REMOVEFIRST() CALLED TODO
		// TESTS ON A TWO-ELEMENT LIST THAT HAD REMOVELAST() CALLED TODO
		...
		printTest("testIndexOfOnAddToFrontIndexedListThreeInvalid", testIndexOfOnAddToFrontIndexedListThreeInvalid());
		...
		printTest("testIndexOfOnAddAfterIndexedListThreeInvalid", testIndexOfOnAddAfterIndexedListThreeInvalid());
		...
		printTest("testIndexOfOnAddAfterSecondIndexedListThreeInvalid", testIndexOfOnAddAfterSecondIndexedListThreeInvalid());
		...
		printTest("testIndexOfOnAddToRearIndexedListThreeInvalid", testIndexOfOnAddToRearIndexedListThreeInvalid());
...
//		printTest("testIteratorHasNextOnAddToRearThree", testIteratorHasNextOnAddToRearThree());
//		printTest("testIteratorNextOnAddToRearThree", testIteratorNextOnAddToRearThree());
//		printTest("testIteratorAddOnAddToRearThree", testIteratorAddOnAddToRearThree());
//		printTest("testIteratorHasPreviousOnAddToRearThree", testIteratorHasPreviousOnAddToRearThree());
//		printTest("testIteratorNextIndexOnAddToRearThree", testIteratorNextIndexOnAddToRearThree());
//		printTest("testIteratorPreviousOnAddToRearThree", testIteratorPreviousOnAddToRearThree());
//		printTest("testIteratorPreviousIndexOnAddToRearThree", testIteratorPreviousIndexOnAddToRearThree());
//		printTest("testIteratorRemoveOnAddToRearThree", testIteratorRemoveOnAddToRearThree());
//		printTest("testIteratorSetOnAddToRearThree", testIteratorSetOnAddToRearThree());
		// /
		// /New Scenarios TODO
		// /
		// 1) [] -> add(A) -> [A]
		...
		printTest("testAddAtIndexOnAddAtFirstTwoValid", testAddAtIndexOnAddAtFirstTwoValid());
		...
		// 9) [A,B] -> set(0,C) -> [C,B] TODO Was working on last
		// printTest("testAddToFrontOnSetFirstTwo",
		// testAddToFrontOnSetFirstTwo());
		// printTest("testAddToRearOnSetFirstTwo",
		// testAddToRearOnSetFirstTwo());
		// printTest("testAddAfterFirstOnSetFirstTwoValid",
		// testAddAfterFirstOnSetFirstTwoValid());
		// printTest("testAddAfterSecondOnSetFirstTwoValid",
		// testAddAfterSecondOnSetFirstTwoValid());
		// printTest("testAddAfterOnSetFirstTwoInvalid",
		// testAddAfterOnSetFirstTwoInvalid());
		// printTest("testRemoveFirstOnSetFirstTwo",
		// testRemoveFirstOnSetFirstTwo());
		// printTest("testRemoveLastOnSetFirstTwo",
		// testRemoveLastOnSetFirstTwo());
		// printTest("testRemoveFirstElementOnSetFirstTwoValid",
		// testRemoveFirstElementOnSetFirstTwoValid());
		// printTest("testRemoveSecondElementOnSetFirstTwoValid",
		// testRemoveSecondElementOnSetFirstTwoValid());
		// printTest("testRemoveElementOnSetFirstTwoInvalid",
		// testRemoveElementOnSetFirstTwoInvalid());
		// printTest("testFirstOnSetFirstTwo", testFirstOnSetFirstTwo());
		// printTest("testLastOnSetFirstTwo", testLastOnSetFirstTwo());
		// printTest("testContainsFirstOnSetFirstTwoValid",
		// testContainsFirstOnSetFirstTwoValid());
		// printTest("testContainsSecondOnSetFirstTwoValid",
		// testContainsSecondOnSetFirstTwoValid());
		// printTest("testContainsOnSetFirstTwoInvalid",
		// testContainsOnSetFirstTwoInvalid());
		// printTest("testIsEmptyOnSetFirstTwo", testIsEmptyOnSetFirstTwo());
		// printTest("testSizeOnSetFirstTwo", testSizeOnSetFirstTwo());
		// printTest("testIteratorOnSetFirstTwo", testIteratorOnSetFirstTwo());
		// printTest("testToStringOnSetFirstTwo", testToStringOnSetFirstTwo());
		//
		// printTest("testAddAtIndexOnSetFirstTwo",
		// testAddAtIndexOnSetFirstTwoValid());
		// printTest("testAddAtIndexOnSetFirstTwoInvalid",
		// testAddAtIndexOnSetFirstTwoInvalid());
		// printTest("testAddV2OnSetFirstTwo", testAddV2OnSetFirstTwo());
		// printTest("testSetFirstOnSetFirstTwoValid",
		// testSetFirstOnSetFirstTwoValid());
		// printTest("testSetSecondOnSetFirstTwoValid",
		// testSetSecondOnSetFirstTwoValid());
		// printTest("testSetOnSetFirstTwoInvalid",
		// testSetOnSetFirstTwoInvalid());
		// printTest("testGetFirstOnSetFirstTwoValid",
		// testGetFirstOnSetFirstTwoValid());
		// printTest("testGetSecondOnSetFirstTwoValid",
		// testGetSecondOnSetFirstTwoValid());
		// printTest("testGetOnSetFirstTwoInvalid",
		// testGetOnSetFirstTwoInvalid());
		// printTest("testIndexOfFirstOnSetFirstTwoValid",
		// testIndexOfFirstOnSetFirstTwoValid());
		// printTest("testIndexOfSecondOnSetFirstTwoValid",
		// testIndexOfSecondOnSetFirstTwoValid());
		// printTest("testIndexOfOnSetFirstTwoInvalid",
		// testIndexOfOnSetFirstTwoInvalid());
		// printTest("testRemoveIndexOnSetFirstTwoValid",
		// testRemoveIndexOnSetFirstTwoValid());
		// printTest("testRemoveIndexOnSetFirstTwoInvalid",
		// testRemoveIndexOnInvalid());
		...
		printTest("testAddToFrontOnIteratorRemoveNextEmpty", testAddToFrontOnIteratorRemoveNextEmpty());
		printTest("testAddToRearOnIteratorRemoveNextEmpty", testAddToRearOnIteratorRemoveNextEmpty());
		printTest("testAddAfterOnIteratorRemoveNextEmpty", testAddAfterOnIteratorRemoveNextEmpty());
		printTest("testRemoveFirstOnIteratorRemoveNextEmpty", testRemoveFirstOnIteratorRemoveNextEmpty());
		printTest("testRemoveLastOnIteratorRemoveNextEmpty", testRemoveLastOnIteratorRemoveNextEmpty());
		printTest("testRemoveElementOnIteratorRemoveNextEmpty", testRemoveElementOnIteratorRemoveNextEmpty());
		printTest("testFirstOnIteratorRemoveNextEmpty", testFirstOnIteratorRemoveNextEmpty());
		printTest("testLastOnIteratorRemoveNextEmpty", testLastOnIteratorRemoveNextEmpty());
		printTest("testContainsOnIteratorRemoveNextEmpty", testContainsOnIteratorRemoveNextEmpty());
		printTest("testIsEmptyOnIteratorRemoveNextEmpty", testIsEmptyOnIteratorRemoveNextEmpty());
		printTest("testSizeOnIteratorRemoveNextEmpty", testSizeOnIteratorRemoveNextEmpty());
		printTest("testIteratorOnIteratorRemoveNextEmpty", testIteratorOnIteratorRemoveNextEmpty());
		printTest("testToStringOnIteratorRemoveNextEmpty", testToStringOnIteratorRemoveNextEmpty());
		printTest("testAddAtIndexOnIteratorRemoveNextEmptyValid", testAddAtIndexOnIteratorRemoveNextEmptyValid());
		printTest("testAddAtIndexOnIteratorRemoveNextEmptyInvalid", testAddAtIndexOnIteratorRemoveNextEmptyInvalid());
		printTest("testAddV2OnIteratorRemoveNextEmpty", testAddV2OnIteratorRemoveNextEmpty());// add(T)
		printTest("testSetOnIteratorRemoveNextEmptyInvalid", testSetOnIteratorRemoveNextEmptyInvalid());
		printTest("testGetOnIteratorRemoveNextEmptyValid", testGetOnIteratorRemoveNextEmptyValid());
		printTest("testIndexOfOnIteratorRemoveNextEmpty", testIndexOfOnIteratorRemoveNextEmpty());
		printTest("testRemoveIndexOnIteratorRemoveNextEmpty", testRemoveIndexOnIteratorRemoveNextEmpty());

		printTest("testIteratorHasNextOnIteratorRemoveNextEmpty", testIteratorHasNextOnIteratorRemoveNextEmpty());
		printTest("testIteratorNextOnIteratorRemoveNextEmpty", testIteratorNextOnIteratorRemoveNextEmpty());
		printTest("testIteratorAddOnIteratorRemoveNextEmpty", testIteratorAddOnIteratorRemoveNextEmpty());
		printTest("testIteratorHasPreviousOnIteratorRemoveNextEmpty", testIteratorHasPreviousOnIteratorRemoveNextEmpty());
		printTest("testIteratorNextIndextOnIteratorRemoveNextEmpty", testIteratorNextIndexOnIteratorRemoveNextEmpty());
		printTest("testIteratorPreviousOnIteratorRemoveNextEmpty", testIteratorPreviousOnIteratorRemoveNextEmpty());
		printTest("testIteratorPreviousIndexOnIteratorRemoveNextEmpty", testIteratorPreviousIndexOnIteratorRemoveNextEmpty());
		printTest("testIteratorRemoveOnIteratorRemoveNextEmpty", testIteratorRemoveOnIteratorRemoveNextEmpty());
		// 7) [A] -> iterator remove() after previous() returns A -> [] TODO
		printTest("testAddToFrontOnIteratorRemovePreviousEmpty", testAddToFrontOnIteratorRemovePreviousEmpty());
		printTest("testAddToRearOnIteratorRemovePreviousEmpty", testAddToRearOnIteratorRemovePreviousEmpty());
		printTest("testAddAfterOnIteratorRemovePreviousEmpty", testAddAfterOnIteratorRemovePreviousEmpty());
		printTest("testRemoveFirstOnIteratorRemovePreviousEmpty", testRemoveFirstOnIteratorRemovePreviousEmpty());
		printTest("testRemoveLastOnIteratorRemovePreviousEmpty", testRemoveLastOnIteratorRemovePreviousEmpty());
		printTest("testRemoveElementOnIteratorRemovePreviousEmpty", testRemoveElementOnIteratorRemovePreviousEmpty());
		printTest("testFirstOnIteratorRemovePreviousEmpty", testFirstOnIteratorRemovePreviousEmpty());
		printTest("testLastOnIteratorRemovePreviousEmpty", testLastOnIteratorRemovePreviousEmpty());
		printTest("testContainsOnIteratorRemovePreviousEmpty", testContainsOnIteratorRemovePreviousEmpty());
		printTest("testIsEmptyOnIteratorRemovePreviousEmpty", testIsEmptyOnIteratorRemovePreviousEmpty());
		printTest("testSizeOnIteratorRemovePreviousEmpty", testSizeOnIteratorRemovePreviousEmpty());
		printTest("testIteratorOnIteratorRemovePreviousEmpty", testIteratorOnIteratorRemovePreviousEmpty());
		printTest("testToStringOnIteratorRemovePreviousEmpty", testToStringOnIteratorRemovePreviousEmpty());
		printTest("testAddAtIndexOnIteratorRemovePreviousEmptyValid", testAddAtIndexOnIteratorRemovePreviousEmptyValid());
		printTest("testAddAtIndexOnIteratorRemovePreviousEmptyInvalid", testAddAtIndexOnIteratorRemovePreviousEmptyInvalid());
		printTest("testAddV2OnIteratorRemovePreviousEmpty", testAddV2OnIteratorRemovePreviousEmpty());// add(T)
		printTest("testSetOnIteratorRemovePreviousEmptyInvalid", testSetOnIteratorRemovePreviousEmptyInvalid());
		printTest("testGetOnIteratorRemovePreviousEmptyValid", testGetOnIteratorRemovePreviousEmptyValid());
		printTest("testIndexOfOnIteratorRemovePreviousEmpty", testIndexOfOnIteratorRemovePreviousEmpty());
		printTest("testRemoveIndexOnIteratorRemovePreviousEmpty", testRemoveIndexOnIteratorRemovePreviousEmpty());

		printTest("testIteratorHasNextOnIteratorRemovePreviousEmpty", testIteratorHasNextOnIteratorRemovePreviousEmpty());
		printTest("testIteratorNextOnIteratorRemovePreviousEmpty", testIteratorNextOnIteratorRemovePreviousEmpty());
		printTest("testIteratorAddOnIteratorRemovePreviousEmpty", testIteratorAddOnIteratorRemovePreviousEmpty());
		printTest("testIteratorHasPreviousOnIteratorRemovePreviousEmpty", testIteratorHasPreviousOnIteratorRemovePreviousEmpty());
		printTest("testIteratorNextIndextOnIteratorRemovePreviousEmpty", testIteratorNextIndexOnIteratorRemovePreviousEmpty());
		printTest("testIteratorPreviousOnIteratorRemovePreviousEmpty", testIteratorPreviousOnIteratorRemovePreviousEmpty());
		printTest("testIteratorPreviousIndexOnIteratorRemovePreviousEmpty", testIteratorPreviousIndexOnIteratorRemovePreviousEmpty());
		printTest("testIteratorRemoveOnIteratorRemovePreviousEmpty", testIteratorRemoveOnIteratorRemovePreviousEmpty());
		// 13) [] -> iterator add(A) -> [A] TODO
//		printTest("testAddToFrontOnIteratorAddOne", testAddToFrontOnIteratorAddOne());
//		printTest("testAddToRearOnIteratorAddOne", testAddToRearOnIteratorAddOne());
//		printTest("testAddAfterOnIteratorAddOneValid", testAddAfterOnIteratorAddOneValid());
//		printTest("testAddAfterOnIteratorAddOneInvalid", testAddAfterOnIteratorAddOneInvalid());
//		printTest("testRemoveFirstOnIteratorAddOne", testRemoveFirstOnIteratorAddOne());
//		printTest("testRemoveLastOnIteratorAddOne", testRemoveLastOnIteratorAddOne());
//		printTest("testRemoveElementOnIteratorAddOneValid", testRemoveElementOnIteratorAddOneValid());
//		printTest("testRemoveElementOnIteratorAddOneInvalid", testRemoveElementOnIteratorAddOneInvalid());
//		printTest("testFirstOnIteratorAddOne", testFirstOnIteratorAddOne());
//		printTest("testLastOnIteratorAddOne", testLastOnIteratorAddOne());
//		printTest("testContainsOnIteratorAddOneValid", testContainsOnIteratorAddOneValid());
//		printTest("testContainsOnIteratorAddOneInvalid", testContainsOnIteratorAddOneInvalid());
//		printTest("testIsEmptyOnIteratorAddOne", testIsEmptyOnIteratorAddOne());
//		printTest("testSizeOnIteratorAddOne", testSizeOnIteratorAddOne());
//		printTest("testIteratorOnIteratorAddOne", testIteratorOnIteratorAddOne());
//		printTest("testToStringOnIteratorAddOne", testToStringOnIteratorAddOne());
//
//		printTest("testAddAtIndexOnIteratorAddOne", testAddAtIndexOnIteratorAddOneValid());
//		printTest("testAddAtIndexOnIteratorAddOneInvalid", testAddAtIndexOnIteratorAddOneInvalid());
//		printTest("testAddV2OnIteratorAddOne", testAddV2OnIteratorAddOne());
//		printTest("testSetOnIteratorAddOneValid", testSetOnIteratorAddOneValid());
//		printTest("testSetOnIteratorAddOneInvalid", testSetOnIteratorAddOneInvalid());
//		printTest("testGetOnIteratorAddOneValid", testGetOnIteratorAddOneValid());
//		printTest("testGetOnIteratorAddOneInvalid", testGetOnIteratorAddOneInvalid());
//		printTest("testIndexOfOnIteratorAddOneValid", testIndexOfOnIteratorAddOneValid());
//		printTest("testIndexOfOnIteratorAddOneInvalid", testIndexOfOnIteratorAddOneInvalid());
//		printTest("testRemoveIndexOnIteratorAddOne", testRemoveIndexOnIteratorAddOne());
//		
//		printTest("testIteratorHasNextOnIteratorAddOne", testIteratorHasNextOnIteratorAddOne());
//		printTest("testIteratorNextOnIteratorAddOne", testIteratorNextOnIteratorAddOne());
//		printTest("testIteratorAddOnIteratorAddOne", testIteratorAddOnIteratorAddOne());
//		printTest("testIteratorHasPreviousOnIteratorAddOne", testIteratorHasPreviousOnIteratorAddOne());
//		printTest("testIteratorNextIndextOnIteratorAddOne", testIteratorNextIndexOnIteratorAddOne());
//		printTest("testIteratorPreviousOnIteratorAddOne", testIteratorPreviousOnIteratorAddOne());
//		printTest("testIteratorPreviousIndexOnIteratorAddOne", testIteratorPreviousIndexOnIteratorAddOne());
//		printTest("testIteratorRemoveOnIteratorAddOne", testIteratorRemoveOnIteratorAddOne());
		// 2) [A,B] -> iterator remove() after next() returns A -> [B] TODO
		// 3) [A,B] -> iterator remove() after next() returns B -> [A] TODO
		// 8) [A,B] -> iterator remove() after previous() returns A -> [B] TODO
		// 9) [A,B] -> iterator remove() after previous() returns B -> [A] TODO

		// 22) [A] -> iterator set(B) after next() returns A -> [B] TODO
		// 23) [A] -> iterator set(B) after previous() returns A -> [B] TODO
		// 4) [A,B,C] -> iterator remove() after next() returns A -> [B,C] TODO
		// 5) [A,B,C] -> iterator remove() after next() returns B -> [A,C] TODO
		// 6) [A,B,C] -> iterator remove() after next() returns C -> [A,B] TODO
		...
		// TODO
		// 14) [A] -> iterator add(B) with new iterator -> [B,A] TODO
		// 15) [A] -> iterator add(B) after next() returns A -> [A,B] TODO
		// 16) [A] -> iterator add(B) after previous() returns A -> [B,A] TODO
		// 24) [A,B] -> iterator set(C) after next() returns A -> [C,B] TODO
		// 25) [A,B] -> iterator set(C) after next() returns B -> [A,C] TODO
		// 26) [A,B] -> iterator set(C) after previous() returns A -> [C,B] TODO
		// 27) [A,B] -> iterator set(C) after previous() returns B -> [A,C] TODO
		// 28) [A,B,C] -> iterator set(D) after next() returns A -> [D,B,C] TODO
		// 29) [A,B,C] -> iterator set(D) after next() returns B -> [A,D,C] TODO
		// 30) [A,B,C] -> iterator set(D) after next() returns C -> [A,B,D] TODO
		...
		// TODO
		// 17) [A,B] -> iterator add(C) with new iterator -> [C,A,B] TODO
		// 18) [A,B] -> iterator add(C) after next() returns A -> [A,C,B] TODO
		// 19) [A,B] -> iterator add(C) after next() returns B -> [A,B,C] TODO
	...
	private boolean testIndexOfOnNewIndexedList() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s\n", "testIndexOfOnNewIndexedList", e.toString());
			return false;
		}
	}
	...
	private boolean testIteratorConstructorOnNewList(){
		DoubleLinkedList<Integer> list = (DoubleLinkedList<Integer>) newIndexedList();
		try {
			Iterator<Integer> it = list.iterator();
			Iterator<Integer> it2 = list.listIterator(0);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorConstructorOnNewList", e.toString());
			return false;
		}	
		return true;
	}
	private boolean testIteratorHasNextOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		Iterator<Integer> it = list.iterator();
		try {
			return (it.hasNext() == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorHasNextOnNewList", e.toString());
			return false;
		}
	}

	private boolean testIteratorNextOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		Iterator<Integer> it = list.iterator();
		try {
			it.next();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorNextOnNewList", e.toString(), "NoSuchElementException");
			return false;
		}
		return false;
	}

	private boolean testIteratorAddOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.add(new Integer(1));
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorAddOnNewList", e.toString());
			return false;
		}
		return true;
	}

	private boolean testIteratorHasPreviousOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.hasPrevious() == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorHasPreviousOnNewList", e.toString());
			return false;
		}
	}

	private boolean testIteratorNextIndexOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.nextIndex() == list.size());
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorNextIndexOnNewList", e.toString());
			return false;
		}
	}

	private boolean testIteratorPreviousOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.previous();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorPreviousOnNewList", e.toString(), "NoSuchElementException");
			return false;
		}
		return false;
	}

	private boolean testIteratorPreviousIndexOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.previousIndex() == -1);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorPreviousIndexOnNewList", e.toString());
			return false;
		}
	}

	private boolean testIteratorRemoveOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.remove();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorRemoveOnNewList", e.toString(), "IllegalStateException");
			return false;
		}
		return false;
	}

	private boolean testIteratorSetOnNewList() {
		IndexedListADT<Integer> list = newIndexedList();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorSetOnNewList", e.toString(), "IllegalStateException");
			return false;
		}
		return false;
	}
	...
	private boolean testAddAtIndexOnRemoveElementIndexedListInvalid() {
		...
		Integer i = new Integer(1);
		try {
			((IndexedListADT<Integer>) list).add(1, i);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s expected %s, caught %s\n", "testRemoveElementOnNewList", "ElementNotFoundException", e.toString());
	...
	private boolean testIndexOfOnRemoveElementIndexedList() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnRemoveElementIndexedList", e.toString());
			return false;
		}
	}
	...
	private boolean testIndexOfOnRemoveFirstIndexedList() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnRemoveFirstIndexedList", e.toString());
			return false;
		}
	}
	...
	private boolean testIndexOfOnRemoveLastIndexedList() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnRemoveLastIndexedList", e.toString());
			return false;
		}
	}
	...
	private boolean testAddAtIndexOnAddToFrontIndexedListOneInvalid() {
		...
		Integer i = new Integer(1);
		try {
			((IndexedListADT<Integer>) list).add(2, i);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testAddV2OnAddToFrontIndexedListOne() {
		...
		Integer i = new Integer(1);
		try {
			((IndexedListADT<Integer>) list).add(i);
		} catch (ElementNotFoundException e) {
			return false;
		} catch (Exception e) {
	...
	private boolean testSetOnAddToFrontIndexedListOneValid() {
		...
		Integer i = new Integer(1);
		try {
			((IndexedListADT<Integer>) list).set(0, i);
		} catch (Exception e) {
	...
	private boolean testSetOnAddToFrontIndexedListOneInvalid() {
		...
		Integer i = new Integer(1);
		try {
			((IndexedListADT<Integer>) list).set(2, i);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testGetOnAddToFrontIndexedListOneValid() {
		UnorderedListADT<Integer> list = newListAddToFrontOne();
		try {
			return (((IndexedListADT<Integer>) list).get(0).equals(new Integer(1)));
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testGetOnAddToFrontIndexedListOneValid", e.toString());
			return false;
		}
	}
	...
	private boolean testIndexOfOnAddToFrontIndexedListOneValid() {
		...
		Integer i = new Integer(1);
		try {
			return (((IndexedListADT<Integer>) list).indexOf(i) == 0);
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testIndexOfOnAddToFrontIndexedListOneInvalid() {
		...
		try {
			return(((IndexedListADT<Integer>) list).indexOf(i) == -1);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddToFrontIndexedListOne", e.toString());
			return false;
		}
	}
	...
	private boolean testGetOnAddToFrontIndexedListOneInvalid() {
		UnorderedListADT<Integer> list = newListAddToFrontOne();
		try {
			((IndexedListADT<Integer>) list).get(2);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testGetOnAddToFrontIndexedListOneInvalid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}
	...
	private boolean testRemoveIndexOnAddToFrontIndexedListOne() {
		UnorderedListADT<Integer> list = newListAddToFrontOne();
		try {
			((IndexedListADT<Integer>) list).remove(1);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testRemoveIndexOnRemoveElementIndexedList", e.toString(), "IndexOutOfBoundsException");
	...
	private boolean testGetOnAddToRearIndexedListOneValid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testGetOnAddToRearIndexedListOneValid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
	}
	...
	private boolean testIndexOfOnAddToRearIndexedListOneInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddToRearIndexedListOne", e.toString());
			return false;
		}
	}
	...
	private boolean testAddAtIndexOnAddToFrontIndexedListTwoInvalid() {
		...
		Integer i = new Integer(3);
		try {
			((IndexedListADT<Integer>) list).add(3, i);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testIndexOfOnAddToFrontIndexedListTwoInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddToFrontIndexedListTwoInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testGetOnAddToFrontIndexedListTwoValid() {
		UnorderedListADT<Integer> list = newListAddToFrontTwo();
		try {
			return (((IndexedListADT<Integer>) list).get(1).equals(new Integer(1)));
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testGetOnAddToFrontIndexedListTwoValid", e.toString());
			return false;
		}
	}
	...
	private boolean testRemoveIndexOnAddToFrontIndexedListTwoValid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testRemoveIndexOnAddToFrontIndexedListTwoValid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return true;
	}
	...
	private boolean testRemoveIndexOnAddToFrontIndexedListTwoInvalid() {
		UnorderedListADT<Integer> list = newListAddToFrontTwo();
		try {
			((IndexedListADT<Integer>) list).remove(2);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testRemoveIndexOnAddToFrontIndexedListTwoInvalid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}
	...
	private boolean testIndexOfOnAddToRearIndexedListTwoInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddToRearIndexedListTwoInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testGetOnAddToRearIndexedListTwoValid() {
		UnorderedListADT<Integer> list = newListAddToRearTwoElement();
		try {
			return (((IndexedListADT<Integer>) list).get(1).equals(new Integer(2)));
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testIndexOfOnAddAfterIndexedListTwoInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddAfterIndexedListTwoInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testIndexOfOnRemoveIndexedListTwoInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnRemoveIndexedListTwoInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testAddAtIndexOnAddToFrontIndexedListThreeInvalid() {
		...
		Integer i = new Integer(4);
		try {
			((IndexedListADT<Integer>) list).add(4, i);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testSetOnAddToFrontIndexedListThreeInvalid() {
		...
		Integer i = new Integer(4);
		try {
			((IndexedListADT<Integer>) list).set(3, i);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testIndexOfOnAddToFrontIndexedListThreeValid() {
		...
		Integer i = new Integer(2);
		try {
			return (((IndexedListADT<Integer>) list).indexOf(i) == 2);
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testIndexOfOnAddToFrontIndexedListThreeInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddToFrontIndexedListThreeInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testGetOnAddToFrontIndexedListThreeValid() {
		UnorderedListADT<Integer> list = newListAddToFrontThree();
		try {
			return (((IndexedListADT<Integer>) list).get(0).equals(new Integer(3)));
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testGetOnAddToFrontIndexedListThreeInvalid() {
		UnorderedListADT<Integer> list = newListAddToFrontThree();
		try {
			((IndexedListADT<Integer>) list).get(4);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testRemoveIndexOnAddToFrontIndexedListThreeInvalid() {
		UnorderedListADT<Integer> list = newListAddToFrontThree();
		try {
			((IndexedListADT<Integer>) list).remove(3);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testRemoveIndexOnAddToFrontIndexedListThree", e.toString(), "IndexOutOfBoundsException");
	...
	private boolean testIndexOfOnAddAfterIndexedListThreeInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddAfterIndexedListThreeInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testIndexOfOnAddAfterSecondIndexedListThreeInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddAfterSecondIndexedListThreeInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testIndexOfOnAddToRearIndexedListThreeInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddToRearIndexedListThreeInvalid", e.toString());
			return false;
		}
	}
	...
	private boolean testAddToFrontOnAddElementOne() {
		...
		Integer i = new Integer(1);
		try {
			((UnorderedListADT<Integer>) list).addToFront(i);
		} catch (Exception e) {
	...
	private boolean testAddToRearOnAddElementOne() {
		...
		Integer i = new Integer(1);
		try {
			((UnorderedListADT<Integer>) list).addToRear(i);
		} catch (Exception e) {
	...
	private boolean testAddAfterOnAddElementOneValid() {
		IndexedListADT<Integer> list = newIndexedListAddOne();
		try {
			((UnorderedListADT<Integer>) list).addAfter(new Integer(2), new Integer(1));
		} catch (Exception e) {
	...
	private boolean testAddAfterOnAddElementOneInvalid() {
		IndexedListADT<Integer> list = newIndexedListAddOne();
		try {
			((UnorderedListADT<Integer>) list).addAfter(new Integer(1), new Integer(2));
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testAddAtIndexOnAddElementOneValid() {
		...
		Integer i = new Integer(1);
		try {
			((IndexedListADT<Integer>) list).add(0, i);
		} catch (ElementNotFoundException e) {
			return false;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testAddAtIndexOnAddElementOneValid", e.toString());
			return false;
		}
		return true;
	}

	private boolean testAddAtIndexOnAddElementOneInvalid() {// TODO
		IndexedListADT<Integer> list = newIndexedListAddAtOne();
		Integer i = new Integer(1);
		try {
			((IndexedListADT<Integer>) list).add(2, i);
	...
	private boolean testIndexOfOnAddElementOneInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddElementOne", e.toString());
			return false;
		}
	}
	...
	private boolean testGetOnAddElementOneInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testIndexOfOnAddElementOne", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}
	...
	private boolean testIndexOfOnAddAtOneInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddAtOne", e.toString());
			return false;
		}
	}
	...
	private boolean testGetOnAddAtOneInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testIndexOfOnAddAtOne", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}
	...
	private boolean testIndexOfOnRemoveIndexEmpty() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnRemoveIndexEmpty", e.toString());
			return false;
		}
	}
	...
	private boolean testAddAfterOnSetOneInvalid() {
		IndexedListADT<Integer> list = newIndexedListSetOne();
		try {
			((UnorderedListADT<Integer>) list).addAfter(new Integer(4), new Integer(1));
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testGetOnSetOneValid() {
		IndexedListADT<Integer> list = newIndexedListSetOne();
		try {
			return (((IndexedListADT<Integer>) list).get(0).equals(new Integer(2)));
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testSetOnSetOneInvalid", e.toString(), "IndexOutOfBoundsException");
	...
	private boolean testGetOnSetOneInvalid() {
		IndexedListADT<Integer> list = newIndexedListSetOne();
		try {
			((IndexedListADT<Integer>) list).get(new Integer(1));
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testIndexOfOnSetOne", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}
	...
	private boolean testIndexOfOnSetOneInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnSetOne", e.toString());
			return false;
		}
	}
	...
	private boolean testGetOnRemoveFirstOneInvalid() {
		IndexedListADT<Integer> list = newIndexedListRemoveFirstOne();
		try {
			((IndexedListADT<Integer>) list).get(3);
		} catch (IndexOutOfBoundsException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testIndexOfOnRemoveFirstOne", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}
	...
	private boolean testIndexOfOnRemoveFirstOneInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnRemoveFirstOne", e.toString());
			return false;
		}
	}
	...
	private boolean testAddAfterFirstOnAddAtFirstTwoValid() {
		IndexedListADT<Integer> list = newIndexedListAddAtFirstTwo();
		try {
			((UnorderedListADT<Integer>) list).addAfter(new Integer(3), new Integer(2));
		} catch (Exception e) {
	...
	private boolean testAddAfterSecondOnAddAtFirstTwoValid() {
		IndexedListADT<Integer> list = newIndexedListAddAtFirstTwo();
		try {
			((UnorderedListADT<Integer>) list).addAfter(new Integer(3), new Integer(1));
		} catch (Exception e) {
			System.out.printf("%s expected %s, caught %s\n", "testAddAfterOnAddAtFirstTwoValid", "No Exception", e.toString());
			return false;
		}
	...
	private boolean testAddAfterOnAddAtFirstTwoInvalid() {
		IndexedListADT<Integer> list = newIndexedListAddAtFirstTwo();
		try {
			((UnorderedListADT<Integer>) list).addAfter(new Integer(4), new Integer(3));
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
	...
	private boolean testSetSecondOnAddAtFirstTwoValid() {
		...
		Integer i = new Integer(3);
		try {
			((IndexedListADT<Integer>) list).set(1, i);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testSetOnAddAtFirstTwoValid", e.toString());
			return false;
		}
	...
	private boolean testIndexOfOnAddAtFirstTwoInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddAtFirstTwo", e.toString());
			return false;
		}
	}
	...
	private boolean testIndexOfOnAddAtSecondTwoInvalid() {
		...
		try {
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnAddAtSecondTwoInvalid", e.toString());
			return false;
		}
	}
	...
	// //////////////////////////
	// SCENARIO: Remove One Element with Iterator after calling next, empty TODO
	// //////////////////////////

	/** @return test success */
	private boolean testAddToFrontOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		Integer i = new Integer(1);
		try {
			list.addToFront(i);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testAddToFrontOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
		return true;
	}
	...
	/** @return test success */
	private boolean testAddToRearOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		Integer i = new Integer(1);
		try {
			list.addToRear(i);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testAddToRearOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
		return true;
	}
	...
	/** @return test success */
	private boolean testAddAfterOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			list.addAfter(new Integer(1), new Integer(2));
		} catch (ElementNotFoundException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testAddAfterOnIteratorRemoveNextEmpty", "ElementNotFoundException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testRemoveFirstOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			list.removeFirst();
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveFirstOnIteratorRemoveNextEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testRemoveLastOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			list.removeLast();
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveLastOnIteratorRemoveNextEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testFirstOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			list.first(); // exception expected
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testFirstOnIteratorRemoveNextEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testRemoveElementOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			list.remove(new Integer(3));
		} catch (ElementNotFoundException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveElementOnIteratorRemoveNextEmpty", "ElementNotFoundException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testLastOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			list.last(); // exception expected
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testLastOnIteratorRemoveNextEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testContainsOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			return (list.contains(new Integer(3)) == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testContainsOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	/** @return test success */
	private boolean testIsEmptyOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			return (list.isEmpty() == true);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testIsEmptyOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	/** @return test success */
	private boolean testSizeOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			return (list.size() == 0);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testSizeOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	/** @return test success */
	private boolean testIteratorOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			Iterator<Integer> it = list.iterator();
			if (it.hasNext() == true) { // should be false
			...
			// iterator() returned null or another invalid type
			System.out.printf("%s caught unexpected %s\n", "testIteratorOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}
	 ...
	 * @return test success
	 */
	private boolean testToStringOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		try {
			String str = list.toString();
			System.out.println("toString() output:\n" + str);
	...
	// IndexedList METHODS NEW LIST
	/* @return test success */
	private boolean testAddAtIndexOnIteratorRemoveNextEmptyValid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemoveEmpty();
		Integer i = new Integer(1);
		try {
			list.add(0, i);
		} catch (ElementNotFoundException e) {
			...
			System.out.printf("%s caught unexpected %s\n", "testAddAtIndexOnIteratorRemoveNextEmptyValid", e.toString());
			return false;
		}
		return true;
	}

	private boolean testAddAtIndexOnIteratorRemoveNextEmptyInvalid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemoveEmpty();
		Integer i = new Integer(1);
		try {
			list.add(1, i);
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveElementOnIteratorRemoveNextEmpty", "testAddAtIndexOnIteratorRemoveNextEmptyInvalid", e.toString());
			return false;
		}
		return false;
	}

	private boolean testAddV2OnIteratorRemoveNextEmpty() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemoveEmpty();
		Integer i = new Integer(1);
		try {
			list.add(i);
			...
			System.out.printf("%s caught unexpected %s\n", "testAddV2OnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
		return true;
	}

	private boolean testSetOnIteratorRemoveNextEmptyInvalid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemoveEmpty();
		Integer i = new Integer(1);
		try {
			list.set(0, i);
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testSetOnIteratorRemoveNextEmptyInvalid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}

	private boolean testGetOnIteratorRemoveNextEmptyValid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemoveEmpty();
		try {
			list.get(0);
		} catch (IndexOutOfBoundsException e) {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testGetOnIteratorRemoveNextEmptyValid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}

	private boolean testIndexOfOnIteratorRemoveNextEmpty() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemoveEmpty();
		Integer i = new Integer(1);
		try {
			return(list.indexOf(i) == -1);
			...
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	private boolean testRemoveIndexOnIteratorRemoveNextEmpty() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemoveEmpty();
		try {
			list.remove(0);
		} catch (IndexOutOfBoundsException e) {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testRemoveIndexOnIteratorRemoveNextEmpty", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}

	private boolean testIteratorHasNextOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		Iterator<Integer> it = list.iterator();
		try {
			return (it.hasNext() == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorHasNextOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorNextOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		Iterator<Integer> it = list.iterator();
		try {
			it.next();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorNextOnIteratorRemoveNextEmpty", e.toString(), "NoSuchElementException");
			return false;
		}
		return false;
	}

	private boolean testIteratorAddOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.add(new Integer(1));
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorAddOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
		return true;
	}

	private boolean testIteratorHasPreviousOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.hasPrevious() == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorHasPreviousOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorNextIndexOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.nextIndex() == list.size());
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorNextIndexOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorPreviousOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.previous();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorPreviousOnIteratorRemoveNextEmpty", e.toString(), "NoSuchElementException");
			return false;
		}
		return false;
	}

	private boolean testIteratorPreviousIndexOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.previousIndex() == -1);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorPreviousIndexOnIteratorRemoveNextEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorRemoveOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.remove();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorRemoveOnIteratorRemoveNextEmpty", e.toString(), "IllegalStateException");
			return false;
		}
		return false;
	}

	private boolean testIteratorSetOnIteratorRemoveNextEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemoveEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.set(new Integer(1));
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorSetOnIteratorRemoveNextEmpty", e.toString(), "IllegalStateException");
			return false;
		}
		return false;
	}
	...
	// //////////////////////////
	// SCENARIO: Remove One Element with Iterator after calling previous, empty
	// TODO
	// //////////////////////////

	/** @return test success */
	private boolean testAddToFrontOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		Integer i = new Integer(1);
		try {
			list.addToFront(i);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testAddToFrontOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
		return true;
	}
	...
	/** @return test success */
	private boolean testAddToRearOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		Integer i = new Integer(1);
		try {
			list.addToRear(i);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testAddToRearOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
		return true;
	}
	...
	/** @return test success */
	private boolean testAddAfterOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			list.addAfter(new Integer(1), new Integer(2));
		} catch (ElementNotFoundException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testAddAfterOnIteratorRemovePreviousEmpty", "ElementNotFoundException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testRemoveFirstOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			list.removeFirst();
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveFirstOnIteratorRemovePreviousEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testRemoveLastOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			list.removeLast();
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveLastOnIteratorRemovePreviousEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testFirstOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			list.first(); // exception expected
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testFirstOnIteratorRemovePreviousEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testRemoveElementOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			list.remove(new Integer(3));
		} catch (ElementNotFoundException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveElementOnIteratorRemovePreviousEmpty", "ElementNotFoundException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testLastOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			list.last(); // exception expected
		} catch (EmptyCollectionException e) {
			...
			System.out.printf("%s expected %s, caught %s\n", "testLastOnIteratorRemovePreviousEmpty", "EmptyCollectionException", e.toString());
			return false;
		}
		return false;
	}
	...
	/** @return test success */
	private boolean testContainsOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			return (list.contains(new Integer(3)) == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testContainsOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	/** @return test success */
	private boolean testIsEmptyOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			return (list.isEmpty() == true);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testIsEmptyOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	/** @return test success */
	private boolean testSizeOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			return (list.size() == 0);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s\n", "testSizeOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	/** @return test success */
	private boolean testIteratorOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			Iterator<Integer> it = list.iterator();
			if (it.hasNext() == true) { // should be false
			...
			// iterator() returned null or another invalid type
			System.out.printf("%s caught unexpected %s\n", "testIteratorOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}
	 ...
	 * @return test success
	 */
	private boolean testToStringOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		try {
			String str = list.toString();
			System.out.println("toString() output:\n" + str);
	...
	// IndexedList METHODS NEW LIST
	/* @return test success */
	private boolean testAddAtIndexOnIteratorRemovePreviousEmptyValid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemovePreviousEmpty();
		Integer i = new Integer(1);
		try {
			list.add(0, i);
		} catch (ElementNotFoundException e) {
			...
			System.out.printf("%s caught unexpected %s\n", "testAddAtIndexOnIteratorRemovePreviousEmptyValid", e.toString());
			return false;
		}
		return true;
	}

	private boolean testAddAtIndexOnIteratorRemovePreviousEmptyInvalid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemovePreviousEmpty();
		Integer i = new Integer(1);
		try {
			list.add(1, i);
			...
			System.out.printf("%s expected %s, caught %s\n", "testRemoveElementOnIteratorRemovePreviousEmpty", "testAddAtIndexOnIteratorRemovePreviousEmptyInvalid", e.toString());
			return false;
		}
		return false;
	}

	private boolean testAddV2OnIteratorRemovePreviousEmpty() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemovePreviousEmpty();
		Integer i = new Integer(1);
		try {
			list.add(i);
			...
			System.out.printf("%s caught unexpected %s\n", "testAddV2OnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
		return true;
	}

	private boolean testSetOnIteratorRemovePreviousEmptyInvalid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemovePreviousEmpty();
		Integer i = new Integer(1);
		try {
			list.set(0, i);
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testSetOnIteratorRemovePreviousEmptyInvalid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}

	private boolean testGetOnIteratorRemovePreviousEmptyValid() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemovePreviousEmpty();
		try {
			list.get(0);
		} catch (IndexOutOfBoundsException e) {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testGetOnIteratorRemovePreviousEmptyValid", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}

	private boolean testIndexOfOnIteratorRemovePreviousEmpty() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemovePreviousEmpty();
		Integer i = new Integer(1);
		try {
			return(list.indexOf(i) == -1);
		}  catch (Exception e) {
			System.out.printf("%s caught unexpected %s \n", "testIndexOfOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	private boolean testRemoveIndexOnIteratorRemovePreviousEmpty() {
		IndexedListADT<Integer> list = (IndexedListADT<Integer>) newIteratorRemovePreviousEmpty();
		try {
			list.remove(0);
		} catch (IndexOutOfBoundsException e) {
			...
			System.out.printf("%s caught unexpected %s, expected %s \n", "testRemoveIndexOnIteratorRemovePreviousEmpty", e.toString(), "IndexOutOfBoundsException");
			return false;
		}
		return false;
	}

	private boolean testIteratorHasNextOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		Iterator<Integer> it = list.iterator();
		try {
			return (it.hasNext() == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorHasNextOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorNextOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		Iterator<Integer> it = list.iterator();
		try {
			it.next();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorNextOnIteratorRemovePreviousEmpty", e.toString(), "NoSuchElementException");
			return false;
		}
		return false;
	}

	private boolean testIteratorAddOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.add(new Integer(1));
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorAddOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
		return true;
	}

	private boolean testIteratorHasPreviousOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.hasPrevious() == false);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorHasPreviousOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorNextIndexOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.nextIndex() == list.size());
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorNextIndexOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorPreviousOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.previous();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorPreviousOnIteratorRemovePreviousEmpty", e.toString(), "NoSuchElementException");
			return false;
		}
		return false;
	}

	private boolean testIteratorPreviousIndexOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			return (it.previousIndex() == -1);
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s", "testIteratorPreviousIndexOnIteratorRemovePreviousEmpty", e.toString());
			return false;
		}
	}

	private boolean testIteratorRemoveOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.remove();
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorRemoveOnIteratorRemovePreviousEmpty", e.toString(), "IllegalStateException");
			return false;
		}
		return false;
	}

	private boolean testIteratorSetOnIteratorRemovePreviousEmpty() {
		UnorderedListADT<Integer> list = newIteratorRemovePreviousEmpty();
		ListIterator<Integer> it = ((DoubleLinkedList<Integer>) list).listIterator();
		try {
			it.set(new Integer(1));
			...
			System.out.printf("%s caught unexpected %s, expected %s", "testIteratorSetOnIteratorRemovePreviousEmpty", e.toString(), "IllegalStateException");
			return false;
		}
		return false;
	}
