...
//		printTest("testAddToFrontOnSetFirstTwo", testAddToFrontOnSetFirstTwo());
//		printTest("testAddToRearOnSetFirstTwo", testAddToRearOnSetFirstTwo());
//		printTest("testAddAfterFirstOnSetFirstTwoValid", testAddAfterFirstOnSetFirstTwoValid());
//		printTest("testAddAfterSecondOnSetFirstTwoValid", testAddAfterSecondOnSetFirstTwoValid());
//		printTest("testAddAfterOnSetFirstTwoInvalid", testAddAfterOnSetFirstTwoInvalid());
//		printTest("testRemoveFirstOnSetFirstTwo", testRemoveFirstOnSetFirstTwo());
//		printTest("testRemoveLastOnSetFirstTwo", testRemoveLastOnSetFirstTwo());
//		printTest("testRemoveFirstElementOnSetFirstTwoValid", testRemoveFirstElementOnSetFirstTwoValid());
//		printTest("testRemoveSecondElementOnSetFirstTwoValid", testRemoveSecondElementOnSetFirstTwoValid());
//		printTest("testRemoveElementOnSetFirstTwoInvalid", testRemoveElementOnSetFirstTwoInvalid());
//		printTest("testFirstOnSetFirstTwo", testFirstOnSetFirstTwo());
//		printTest("testLastOnSetFirstTwo", testLastOnSetFirstTwo());
//		printTest("testContainsFirstOnSetFirstTwoValid", testContainsFirstOnSetFirstTwoValid());
//		printTest("testContainsSecondOnSetFirstTwoValid", testContainsSecondOnSetFirstTwoValid());
//		printTest("testContainsOnSetFirstTwoInvalid", testContainsOnSetFirstTwoInvalid());
...
//
//		printTest("testAddAtIndexOnSetFirstTwo", testAddAtIndexOnSetFirstTwoValid());
//		printTest("testAddAtIndexOnSetFirstTwoInvalid", testAddAtIndexOnSetFirstTwoInvalid());
//		printTest("testAddV2OnSetFirstTwo", testAddV2OnSetFirstTwo());
//		printTest("testSetFirstOnSetFirstTwoValid", testSetFirstOnSetFirstTwoValid());
//		printTest("testSetSecondOnSetFirstTwoValid", testSetSecondOnSetFirstTwoValid());
//		printTest("testSetOnSetFirstTwoInvalid", testSetOnSetFirstTwoInvalid());
//		printTest("testGetFirstOnSetFirstTwoValid", testGetFirstOnSetFirstTwoValid());
//		printTest("testGetSecondOnSetFirstTwoValid", testGetSecondOnSetFirstTwoValid());
//		printTest("testGetOnSetFirstTwoInvalid", testGetOnSetFirstTwoInvalid());
//		printTest("testIndexOfFirstOnSetFirstTwoValid", testIndexOfFirstOnSetFirstTwoValid());
//		printTest("testIndexOfSecondOnSetFirstTwoValid", testIndexOfSecondOnSetFirstTwoValid());
//		printTest("testIndexOfOnSetFirstTwoInvalid", testIndexOfOnSetFirstTwoInvalid());
//		printTest("testRemoveIndexOnSetFirstTwoValid", testRemoveIndexOnSetFirstTwoValid());
//		printTest("testRemoveIndexOnSetFirstTwoInvalid", testRemoveIndexOnInvalid());
	...
	private boolean testIndexOfOnAddToFrontIndexedListOneInvalid() {
		...
		try {
			((IndexedListADT<Integer>) list).indexOf(i);
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testIndexOfOnAddToFrontIndexedListOne", e.toString(), "ElementNotFoundException");
	...
	private boolean testGetOnAddElementOneInvalid() {
		IndexedListADT<Integer> list = newIndexedListAddAtOne();
		try {
			((IndexedListADT<Integer>) list).indexOf(2);
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
			System.out.printf("%s caught unexpected %s, expected %s \n", "testIndexOfOnAddElementOne", e.toString(), "ElementNotFoundException");
	...
	private boolean testGetOnSetOneInvalid() {
		IndexedListADT<Integer> list = newIndexedListSetOne();
		try {
			((IndexedListADT<Integer>) list).indexOf(1);
		} catch (ElementNotFoundException e) {
			return true;
		} catch (Exception e) {
